...
export function FriendRequest(props: IYourFriendsProps) {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.friends}>
        <View>
          <Text style={styles.friendsTitle}>Friend requests (6)</Text>
        </View>
      </View>
      <View style={styles.friendsWrapper}>
        <ScrollView contentContainerStyle={{ gap: 20 }} horizontal>
          {Array.from([1, 2, 3, 4, 5], (v, ind) => {
            return (
              <View key={ind} style={{ width: ITEM_SIZE, paddingBottom: 20 }}>
                <Card
                  style={{
                ...
                >
                  <Card.Cover
                    source={{
                      uri: "https://media.glamour.com/photos/56957b2a085ae0a85036c354/master/pass/entertainment-2015-03-nicki-minaj-main.jpg",
                    }}
                  />
                  <Card.Actions
                  ...
                  >
                    <View style={styles.cardActionsWrapper}>
                      <Text style={{ fontWeight: "bold" }}>romeus clarens</Text>
                      <View
                        style={{
                          flex: 1,
                          flexDirection: "row",
...
const styles = StyleSheet.create({
  ...
  friends: { marginHorizontal: 10, marginVertical: 10 },
  friendsTitle: {
    fontWeight: "bold",
    fontSize: 25,
  },
