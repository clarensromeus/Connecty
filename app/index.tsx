...
export default function LoginScreen(props: IAppProps) {
  ...
  return (
    <View style={styles.container}>
      ...
      <View>
        <Text variant="headlineSmall">Login with connecty</Text>
      </View>
      ...
      <View style={styles.submit}>
        <View>
          <Link style={styles.forgot} href={"/(user)/settings"}>
            forgot password
          </Link>
        </View>
        <Button
          mode="contained"
          onPress={() => {
            // navigate to the first page of the tabs
      ...
      <View style={styles.account}>
        <Text variant="labelLarge">no account created? </Text>
        <Link style={styles.RegisterTextLink} href={"/register"}>
          register
        </Link>
      </View>
